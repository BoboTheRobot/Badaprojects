...
public:
	...
	static const RequestId REQUEST_GALLERYFORM = 102;
	static const RequestId REQUEST_DETAILVIEW = 103;
	static const RequestId REQUEST_SETTINGSFORM = 104;
	static const RequestId REQUEST_HELPFORM = 105;
