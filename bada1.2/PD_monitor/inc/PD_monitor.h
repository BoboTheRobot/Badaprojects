#ifndef _PD_MONITOR_H_
#define _PD_MONITOR_H_
...
/**
 * [PD_monitor] application must inherit from Application class
...
public:
	...
	/**
	 * [PD_monitor] application must have a factory method that creates an instance of itself.
	 */
